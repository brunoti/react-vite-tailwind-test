...
export const Field = kurasu.textarea<TextareaProps>(
...
export const Label = kurasu.label<Pick<TextareaProps, 'status'>>(
...
export const Message = kurasu.p<Pick<TextareaProps, 'status'>>(
	({ status = Status.normal }) =>
		merge([
